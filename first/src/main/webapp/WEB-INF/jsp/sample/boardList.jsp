...
<body>
	<header>
		...
		<div class="btn_list">
			<input type="button" value="엑셀 다운로드" class="btn btn-excel-download"
				...
				$(function() {
					$('#searchBtn').click(
							function() {
								...
								comSubmit.addParam("searchType", $("select option:selected").val());
								comSubmit.addParam("keyword",$('#keywordInput').val());
								comSubmit.submit();
							});
				});
			</script>
	...
	<script type="text/javascript">
		...
		/*
		function fn_searchBar(){
			console.log(${scri.keyword});
			//var comSubmit = new ComSubmit();
			//comSubmit.setUrl("<c:url value='/sample/openBoardList.do' />");
			//comSubmit.addParam("keyword", scri.keyword);
			//comSubmit.addParam("searchType", scri.searchType);
			//comSubmit.submit();
		}
